...
- Guía interactiva: [`docs/site/modules/credit-card/index.html`](../../docs/site/modules/credit-card/index.html)
- Documentación central: [`docs/system-overview.md`](../../docs/system-overview.md#-credit-card---gestión-de-tarjetas-de-crédito)
